...
class CompraController extends Controller
{
    ...
    {   
        $datos     = Posproceso::where('tipo_proceso','=','compra')->where('status','=',1)->orderBy('created_at', 'desc')->get();
        $sistema   = Configuracion::where('id', '=', 1)->firstOrFail();
    ...
    {   
        $datos     = Posproceso::where('tipo_proceso','=','compra')->where('status','=',0)->orderBy('created_at', 'desc')->get();
        $sistema   = Configuracion::where('id', '=', 1)->firstOrFail();
    ...
    {   
        $datos     = Posproceso::where('tipo_proceso','=','compra')->where('status','=',2)->orderBy('created_at', 'desc')->get();
        $sistema   = Configuracion::where('id', '=', 1)->firstOrFail();
    ...
    public function pos_insertar_producto_temporal(Request $request)
    {
        ...
        //Si todo se cumple, registra el producto en temporales
            ...
            try {
                ...
                $datos  = Temporales::whereProductoId($producto_id)->whereUsuarioId(\Session::get("usuario_id"))->whereTipoProceso('compra')->firstOrFail();
    ...
    public function pos_descuento(Request $request)
    {
        ...
        $datos = Temporales::where('usuario_id','=',$usuario_id)->where('tipo_proceso','=','compra')->get();
    ...
    public function pos_total(Request $request){
        ...
        try{
            ...
            //Datos de usuario en Temporales
            $datos = Temporales::where('usuario_id','=',$request->get('usuario_id'))->where('tipo_proceso','=','compra')->get();
    ...
    public function pos_procesar(Request $request){
        ...
        try{
                ...
                $datos_temporales = Temporales::where('usuario_id','=',$usuario_id)->where('tipo_proceso','=','compra')->get();
                ...
                foreach ($datos_temporales as $key => $d) {
                    ...
                    $eliminar_temporal = Temporales::whereUsuarioId($usuario_id)->whereTipoProceso('compra');
    ...
    {        
        ...
        $datos    = Posproceso::where('tipo_proceso','=','compra')->where('id','=',$id)->firstOrFail();
    ...
    {        
        ...
        $reviews = Posproceso::where("tipo_proceso","=","compra")->where("status","=",1)->orderBy('created_at', 'desc')->get();
        $sistema = Configuracion::where('id', '=', 1)->firstOrFail();
    ...
    {        
        ...
        $reviews = Posproceso::where("tipo_proceso","=","compra")->where("status","=",0)->orderBy('created_at', 'desc')->get();
        $sistema = Configuracion::where('id', '=', 1)->firstOrFail();
    ...
    {        
        ...
        $reviews = Posproceso::where("tipo_proceso","=","compra")->where("status","=",2)->orderBy('created_at', 'desc')->get();
        $sistema = Configuracion::where('id', '=', 1)->firstOrFail();
        $columns = array("#","Code","Registered by","Customers", "Subtotal (Tax free)", "Taxes", "Total (Tax included)","Discount"."(%)", "Discounted amount"." ($sistema->moneda)","PAID OUT"." ($sistema->moneda)","Quantity","Type of payment", "Date","Commentary");
