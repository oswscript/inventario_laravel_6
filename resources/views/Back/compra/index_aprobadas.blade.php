...
@section('active-compras-aprobadas', 'active')
@section('content')
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="page-title-box">
                        <h4 class="page-title">@lang('idioma.compra_apro_titu')</h4>
                        <ol class="breadcrumb p-0 m-0">
                            <li>
                                <a href="{{ url('/dash') }}">{{$sistema->nombre_empresa}}</a>
                            </li>
                            <li class="active">
                                @lang('idioma.compra_apro_titu')
                            </li>
                        </ol>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-box table-responsive">
                        ...
                        @if(Session::get("rol_id"))
                            <h3 class="box-title"><a href="{{url('/pdf_compras_aprobadas')}}" class="btn btn-danger pull-right"><i class="fa fa-file-pdf-o"></i>{{" PDF "}}</a></h3>
                            <h3 class="box-title"><a href="{{url('/csv_compras_aprobadas')}}" class="btn btn-success pull-right"><i class="fa fa-file-excel-o"></i>{{" CSV "}}</a></h3>
                        @endif

                        <h4 class="m-t-0 header-title"><b>@lang('idioma.compra_apro_list')</b></h4>
