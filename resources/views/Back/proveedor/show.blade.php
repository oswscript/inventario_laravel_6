                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0 m-0">
                            ...
                            <li>
                                <a href="{{ url('/proveedores') }}">@lang('idioma.nav_proveedores')</a>
                            </li>
                            <li class="active">
                    ...
                    <div class="card-box">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                @endif
                                <div class="form-group">
                                    <label for="nombreProveedor">@lang('idioma.gral_nombre')</label>
                                    <input type="text" value="{{ $datos->nombre }}" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="apellidoProveedor">@lang('idioma.gral_apellido')</label>
                                    <input type="text" value="{{ $datos->apellido }}" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="cedulaProveedor">@lang('idioma.cliente_cr')</label>
                                    <input type="text" value="{{ $datos->cedula }}" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="empresaProveedor">@lang('idioma.cliente_empresa')</label>
                                    <input type="text" value="{{ $datos->empresa }}" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="correoProveedor">@lang('idioma.gral_correo')</label>
                                    <input type="text" value="{{ $datos->correo }}" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="telefonoProveedor">@lang('idioma.cliente_telef')</label>
                                    <input type="text" value="{{ $datos->telefono }}" class="form-control" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="direccionProveedor">@lang('idioma.gral_direcci')</label>
                                    <textarea class="form-control" readonly>{{ $datos->direccion }}</textarea>
                                </div>
                                <a href="{{ url('/proveedores') }}"><button type="button" class="btn btn-default"><i class="fa fa-chevron-left"></i> @lang('idioma.gral_btn_atras') </button></a>
                                <a href="{{ url('/editar_proveedor',$datos->id) }}"><button type="submit" class="btn btn-info"><i class="fa fa-edit"></i> @lang('idioma.gral_btn_edit') </button></a>
                                <a href="{{ url('/borrar_proveedor',$datos->id) }}"><button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i> @lang('idioma.gral_btn_borr') </button></a>
                            </div>
                        </div>
                    </div>
                </div>
