                        ...
                        <div class="row">
                            <div class="col-md-12">
                               ...
                               <form class="form-horizontal" method="POST">
                                  ...
                                  <div class="form-group">
                                      <label for="empresaProveedor">@lang('idioma.cliente_empresa') (@lang('idioma.pos_opcional'))</label>
                                  ...
                                  <div class="form-group">
                                      <label for="telefonoProveedor">@lang('idioma.cliente_telef') (@lang('idioma.pos_opcional'))</label>
                                  ...
                                  <div class="form-group">
                                      <label for="direccionProveedor">@lang('idioma.gral_direcci') (@lang('idioma.pos_opcional'))</label>
                                      <textarea name="direccion" class="form-control" id="direccion" name="direccion">{{ $datos->direccion }}</textarea>
                                  </div>
			                        </div>
			                      <div class="box-footer">
			                        <a href="{{ url('/show_proveedor',$datos->id) }}"><button type="button" class="btn btn-default"><i class="fa fa-chevron-left"></i> @lang('idioma.gral_btn_atras') </button></a>
